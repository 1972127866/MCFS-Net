...
def main(opts):
    ...
    os.makedirs(os.path.join(opts.save_dir,opts.classname,target_name), exist_ok=True)
    # print(target_list)
    ...
    for bid, batch in enumerate(test_dataloader):
        ...
        with torch.no_grad():
            ...
            torchvision.utils.save_image(img_gen_all, os.path.join(opts.save_dir,opts.classname,target_name, "%04d.jpg" %(bid+1)), normalize=True, range=(-1, 1))
