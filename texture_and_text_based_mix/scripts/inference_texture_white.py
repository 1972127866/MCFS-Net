...
from datasets.test_dataset_texture_white import TestLatentsDataset
...
def main(opts):
    ...
    os.makedirs(os.path.join(opts.save_dir,opts.texture_classname,opts.white_classname), exist_ok=True)
    # print(target_list)
    ...
    for bid, batch in enumerate(test_dataloader):
        ...
        with torch.no_grad():
            ...
            torchvision.utils.save_image(img_gen_all, os.path.join(opts.save_dir,opts.texture_classname,opts.white_classname, "%04d.jpg" %(bid+1)), normalize=True, range=(-1, 1))
