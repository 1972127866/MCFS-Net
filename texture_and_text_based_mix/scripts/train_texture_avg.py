...
from datasets.train_dataset_texture_avg import TrainLatentsDataset
...
def main(opts):
    ...
    for batch_idx, batch in enumerate(train_dataloader):
        ...
        # print("delta_s[0][4*512:4*512+10]",delta_s[0][4*512:4*512+10])
        ...
        if batch_idx % opts.save_interval == 0:
            if opts.modi_loss:
                ...
                torch.save(net.state_dict(), os.path.join(opts.checkpoint_path, "avg",opts.images_classname,opts.texture_classname,"net_%06d.pth" % batch_idx))
