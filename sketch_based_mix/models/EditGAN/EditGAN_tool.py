...
class Tool(object):
    def __init__(self, ce_loss_weight=1, encoder_loss_weight=1):
        ...
        # args_file = "experiments/tool_cloth_collar.json"
        # args_file = "experiments/tool_cloth_620t.json"
        # args_file = "experiments/tool_cloth_360t.json"
        args_file = "experiments/tool_cloth_360t_v2.json"
    ...
    def run_seg(self, optimized_latent,use_style=False,input_styles=None):
        if use_style:
            img_out, affine_layers = latent_to_image(self.g_all, self.bi_upsamplers, None, process_out=True,
                                                    return_upsampled_layers=False,
                                                    use_style_latents=True, return_only_im=False,use_style=True,input_styles=input_styles)
        else:
