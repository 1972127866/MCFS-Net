...
class FPN(nn.Module):
    def __init__(self, input_dim, block, num_blocks):#block=Bottleneck
        ...
        # Bottom-up layers   ；num_blocks = [3, 4, 6, 3]
...
class FPNEncoder(nn.Module):#stylegan_encoder = FPNEncoder(3, n_latent=args['n_latent'], only_last_layer=args['use_w'], same_view_code=args['same_view_code'])
