...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--clothstyle_manipulation_prob', default=1, type=float, help='Probability of only manipulating the clothstyle')
		self.parser.add_argument('--color_manipulation_prob', default=0, type=float, help='Probability of only manipulating the color')
		self.parser.add_argument('--both_manipulation_prob', default=0, type=float, help='Probability of simultaneously manipulating clothstyle and color')

		self.parser.add_argument('--clothstyle_text_manipulation_prob', default=1, type=float, help='Probability of using text to manipulate clothstyle')
		self.parser.add_argument('--color_text_manipulation_prob', default=0, type=float, help='Probability of using text to manipulate color')
		...
		self.parser.add_argument('--stylegan_checkpoint_path', default=None, type=str, help='Path to stylegan model checkpoint')
		...
		self.parser.add_argument('--clothstyle_description', required=True, type=str, help='clothstyle text prompt list')
